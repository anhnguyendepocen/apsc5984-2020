...
```{r, include = TRUE, fig.align = "center", fig.cap = c("File: GAPIT.MLM.EarHT.Manhattan.Plot.Genomewise.pdf"), echo = FALSE}
knitr::include_graphics(path = 'GAPIT.MLM.EarHT.Manhattan.Plot.Genomewise.pdf')
```
