...
# lme4 R package
We can confirm our results using the [lme4](https://cran.r-project.org/web/packages/lme4/index.html) R package. 
```{r, eval=FALSE, echo=TRUE}
...
# lme4 R package
We can also confirm our results using the [rrBLUP](https://cran.r-project.org/web/packages/rrBLUP/index.html) R package  
```{r, eval=FALSE, echo=TRUE}
